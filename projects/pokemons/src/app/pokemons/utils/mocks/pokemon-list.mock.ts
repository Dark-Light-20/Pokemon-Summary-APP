import { PokemonList, PokemonListRS } from '../../models/pokemon.model';

export const POKEMON_LIST_RS_MOCK: PokemonListRS = {
  count: 1281,
...
export const POKEMON_LIST_MOCK: PokemonList[] =
  POKEMON_LIST_RS_MOCK.results.map((pokemon, index) => ({
    name: pokemon.name,
    id: (index + 1).toString(),
  }));
